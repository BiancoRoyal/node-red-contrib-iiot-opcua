...
var REDPath = require.resolve("node-red");
console.log(REDPath)
REDPath = REDPath.replace('\\red.js','')
REDPath = REDPath.replace('/red.js','')
console.log(REDPath)

var RED = require("node-red");
var redNodes = require(REDPath + "/runtime/nodes");
var flows = require(REDPath + "/runtime/nodes/flows");
var credentials = require(REDPath + "/runtime/nodes/credentials");
var comms = require(REDPath + "/api/editor/comms.js");
var log = require(REDPath + "/runtime/log.js");
var context = require(REDPath + "/runtime/nodes/context.js");
var events = require(REDPath + "/runtime/events.js");

var http = require('http');
var app = express();

var logSpy = sinon.spy(log,"log");
